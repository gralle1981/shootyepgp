...
Results will print here when done.]],
  ...
  ["New Minimum EP"] = true,
  -- autoloot
  ["Auto-loot Trash"] = true,
  ["Enable Auto-loot"] = true,
  ["Automatically hand off items at or below the chosen quality to a designated player when the loot window opens."] = true,
  ["Auto-loot up to Quality"] = true,
  ["Items at or below this quality are auto-assigned."] = true,
  ["Items at or below this quality are auto-assigned. BoP and quest items are always skipped, so only BoE items are picked up - BoP items still go through the normal bid system."] = true,
  ["Poor (Gray)"] = true,
  ["Common (White)"] = true,
  ["Uncommon (Green)"] = true,
  ["1. Poor (Gray, BoE only)"] = true,
  ["2. Common (White, BoE only)"] = true,
  ...
  ["Auto-loot: could not find %s among the master loot candidates for this corpse."] = true,
} end)
